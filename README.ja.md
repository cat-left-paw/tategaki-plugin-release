...
※ TipTap版の執筆モードは、現在も「互換モード」として利用できますが、将来のアップデートで廃止する可能性があります。
...
- **（新）執筆・参照モード**
    ...
    - SoT の選択モード切り替え（クリック優先 / ドラッグ選択優先）
    - ルビ（青空文庫形式の記法をサポート）
        - 例: `｜漢字《かんじ》`
...
> **予告**: 互換モードは将来のアップデートで廃止する可能性があります。継続利用している場合は、できるだけ（新）執筆・参照モードへの移行をおすすめします。
